    ...
    <>
      <main className={styles.content}>
                ...
                >
                  <td>
                    <div className={styles.rankCell}>
                      {leader.rank <= 3 ? (
                        <span className={`${styles.rankMedal} ${styles[`rank${leader.rank}`]}`}>
                          {leader.rank}
                        </span>
                      ) : (
                  ...
                  <td>
                    <div className={styles.memberCell}>
                      <div className={`${styles.avatar} ${styles[leader.accent]}`}>
                        {leader.avatarUrl ? (
                          <img src={leader.avatarUrl} alt={`${leader.username} avatar`} />
                        ) : (
        ...
        <div className={styles.actionRow}>
          ...
          >
            {canShowMore
              ? `XEM THÊM ${Math.min(3, leaders.length - visibleCount)} NGƯỜI KHÁC`
              : "ĐÃ HIỂN THỊ TẤT CẢ"}
            <span>v</span>
          </button>
        </div>
      ...
      <footer className={styles.footer}>
        <div>
          ...
          <span>© 2026 ByeBug Online Judge. Built for heavy performance.</span>
        </div>
        <nav>
