...
const POPULAR = [
    { id: 1, title: 'Tính tổng 2 số nguyên', acRate: '89%', submissions: '1.3k', difficulty: 'easy' },
    { id: 2, title: 'Kiểm tra số nguyên tố', acRate: '89%', submissions: '1.3k', difficulty: 'medium' },
    { id: 3, title: 'Bài toán dương di',     acRate: '89%', submissions: '1.3k', difficulty: 'hard' },
];
...
function diffLabel(d: string) {
    const map: Record<string, string> = { easy: 'Dễ', medium: 'Vừa', hard: 'Khó', EASY: 'Dễ', MEDIUM: 'Vừa', HARD: 'Khó' };
    return map[d] ?? d;
}
            ...
            <div className={styles.mainArea}>
                ...
                <div className={styles.topbar}>
                    ...
                    <div className={styles.topbarRight}>
                        <button className={styles.bellBtn} title="Thông báo">🔔</button>
                    </div>
                </div>
                        ...
                        <div className={styles.heroCard}>
                            <div>
                                ...
                                <p className={styles.heroSub}>
                                    {TOTAL_PROBLEMS} bài toán · C++, Python, Pascal · Kết quả tức thì
                                </p>
                            </div>
                            ...
                            {!loadingProblems && problems.map((p) => (
                                ...
                                >
                                    <div className={styles.problemRowLeft}>
                                        <span className={styles.problemRowTitle}>
                                            {p.title}
                                        </span>
