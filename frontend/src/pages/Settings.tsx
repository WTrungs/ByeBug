                    ...
                    <div className={styles.settingsCard}>
                        ...
                        <section>
                            ...
                            <form onSubmit={handleChangePassword}>
                                ...
                                <button type="submit" className={styles.secondaryBtn}>Cập nhật mật khẩu</button>
                            </form>
                        </section>
                        ...
                        {/* Danger Zone */}
                        <section>
                            <h2 className={`${styles.sectionTitle} ${styles.dangerTitle}`}>⚠️ Vùng nguy hiểm</h2>
                            <p className={styles.dangerText}>
                                Khi bạn xóa tài khoản, mọi dữ liệu bài nộp và điểm số sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn tác.
                            </p>
