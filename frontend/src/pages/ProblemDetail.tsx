...
import CodeWorkspacePanel, { type SubmitStats } from "../components/CodeWorkspacePanel";
import { ProblemDetailHeader } from "../components/ProblemDetailChrome";
