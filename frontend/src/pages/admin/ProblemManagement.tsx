...
const ProblemManagement: React.FC = () => {
    ...
    const problems = [
        { id: 1, title: 'Two Sum', difficulty: 'EASY', submissions: 1250, status: 'STABLE', lastUpdate: '2024-05-10' },
        { id: 2, title: 'Longest Path', difficulty: 'HARD', submissions: 850, status: 'BUGGED', lastUpdate: '2024-05-12' },
        { id: 3, title: 'Palindromic String', difficulty: 'MEDIUM', submissions: 2100, status: 'STABLE', lastUpdate: '2024-05-08' },
    ];
            ...
            <div className="pm-card">
                <div className="pm-table-header">
                    ...
                    <div className="pm-filter-row">
                        ...
                        <select className="pm-select" value={diffFilter} onChange={e => setDiffFilter(e.target.value)}>
                    ...
                    <tbody>
                        {filtered.map((prob) => (
                            <tr key={prob.id}>
                                ...
                                <td className="pm-subs-cell">{prob.submissions.toLocaleString()}</td>
                                <td className="pm-date-cell">{prob.lastUpdate}</td>
                                <td>
                                    <div className="pm-actions">
                                        <button className="pm-btn-edit" title="Chỉnh sửa">✏️</button>
                                        <button className="pm-btn-delete" title="Xóa">🗑️</button>
                                    </div>
                                </td>
                            </tr>
                        ))}
